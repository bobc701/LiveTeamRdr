...
namespace LiveTeamRdrApi.BusinessLogic {
   ...
   public static class Mapping_cust {
      ...
      public static List<ZBatting> ToZBatting(this ObjectResult<Batting1_cust_Result> listIn) {
         // ---------------------------------------------------------------------
      ...
      public static List<ZGamesByPosn> ToZGamesByPosn(this ObjectResult<GamesByPosn1_cust_Result> listIn) {
         // ---------------------------------------------------------------------
      ...
      public static List<ZPitching> ToZPitching(this ObjectResult<Pitching1_cust_Result> listIn) {
         // ---------------------------------------------------------------------
      ...
      public static List<ZFieldingYear> ToZFieldingYear(this ObjectResult<FieldingYear1_cust_Result> listIn) {
         // ---------------------------------------------------------------------
